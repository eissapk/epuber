...
function BookInfo({ coverPath, epub, onBookOpen }: { coverPath: string; epub: any; onBookOpen: () => void }) {
  return (
    <div className="flex justify-center items-center gap-6 h-[100vh] flex-col md:flex-row">
      ...
      <div className="flex flex-col gap-y-4 max-w-64 items-center md:items-start">
        <h1 title={epub.bookTitle} className="text-white truncate max-w-64 md:max-w-full text-3xl md:text-xl lg:text-2xl 2xl:text-3xl">
          {epub.bookTitle}
        </h1>
